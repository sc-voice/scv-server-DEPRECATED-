(function (exports) {
  ...
  const PATHNAME_DEFAULT = (opts = {}) => {
    var { suttaId, lang, nikaya, major, author, speaker, extension } = opts;
  ...
  class AudioUrls {
    ...
    buildUrl(opts) {
      ...
      var { major, author, speaker, suttaId, extension } = opts || {};
      if (suttaId == null) {
        throw new Error(
      ...
      var extension =
        opts.extension || defaultSource.extension || "noExtension";
      var buildPathName =
        opts.pathName || defaultSource.pathName || PATHNAME_DEFAULT;
