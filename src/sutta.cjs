(function (exports) {
  ...
  class Sutta {
    constructor(opts = {}) {
      ...
      this.author = opts.author || this.translation.author || "(no-author)";
      this.lang = opts.lang || "en";
      this.sections =
        opts.sections || Sutta.defaultSections(segments, this.lang);
    ...
    static excerpt(segments, opts = {}) {
      ...
      if (opts.prop != null) {
        ...
        return segments.reduce((acc, seg, i) => {
          ...
          if (segtext == null) {
            throw new Error(
              `Expected property "${opts.prop}" ` + `in ${JSON.stringify(seg)}`
            );
          }
