typeof describe === "function" &&
  describe("audio-trans", function () {
    ...
    it("concatAudio(files) returns MP3 file", async () => {
      ...
      should(probeOut).match(/title\s*:\s*test_title/imsu);
      should(probeOut).match(/\bartist\s*:\s*test_artist/imsu);
      should(probeOut).match(/album\s*:\s*test_album/imsu);
      should(probeOut).match(/album_artist\s*:\s*test-album-artist/imsu);
      should(probeOut).match(/comment\s*:\s*test_comment/imsu);
      should(probeOut).match(new RegExp(`date\\s*:\\s*${date}`, `msiu`));
      should(probeOut).match(
      ...
      should(probeOut).match(/genre\s*:\s*Dhamma/imsu);
    });
    it("concatAudio(files) returns Opus file", async () => {
      ...
      should(probeOut).match(/\bartist\s*:\s*test_artist/imsu);
      should(probeOut).match(/album\s*:\s*test_album/imsu);
      should(probeOut).match(/album_artist\s*:\s*test_album_artist/imsu);
      should(probeOut).match(/comment\s*:\s*test_comment/imsu);
      ...
      should(probeOut).match(new RegExp(`date\\s*:\\s*${date}`, `msiu`));
      should(probeOut).match(/genre\s*:\s*Dhamma/imsu);
      should(probeOut).match(/comment\s*:\s*Cover/imsu);
    });
  });
